            ...
            for trd in range(v):
                for frt in range(v):
                    for fth in range(v):
                        ...
                        #progress (:
                        prg = fst*49787136 + snd*592704 + trd*7056 + frt*84 + fth
                        
                        if fth == 0:
                            print((prg/4100000000)*100 , '%')
                        ...
                        orderedpairs.append([fst,0])
                        used.append(fst)
                        if snd in used:
                            skip = True;
                        else:
                            orderedpairs.append([snd,1])
                            used.append(snd)

                        if trd in used:
                            skip = True;
                        else:
                            orderedpairs.append([trd,2])
                            used.append(trd)

                        if frt in used:
                            skip = True;
                        else:
                            orderedpairs.append([frt,3])
                            used.append(frt)
                            
                        if fth in used:
                            skip = True;
                        else:
                            orderedpairs.append([fth,4]);
                        ...
                        if skip == False:
                            ...
                            y5 = orderedmat[4][1];
                            fivepairs = [[x1,y1,fst],[x2,y2,snd],[x3,y3,trd],[x4,y4,frt],[x5,y5,fth]]
                            ...
                            if total <= 50:
                                ...
                                data[key] = val;
                                print(fivepairs)
                                listofviablestarts.append(fivepairs)
                        ...
                        #print(pathlist);
    #print(groups, values);
    for starts in listofviablestarts:
        print(starts)
